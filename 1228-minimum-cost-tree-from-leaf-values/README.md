<h2><a href="https://leetcode.com/problems/minimum-cost-tree-from-leaf-values">1228. Minimum Cost Tree From Leaf Values</a></h2><h3>Medium</h3><hr><p>Given an array <code>arr</code> of positive integers, consider all binary trees such that:</p>
